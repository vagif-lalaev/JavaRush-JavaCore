...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(classWithStatic.equals(loadedObject) ? "равны" : "неравны");
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            //записываем данные согласно объявленному порядку в классе
            BufferedWriter writer = new BufferedWriter(new OutputStreamWriter (outputStream));
            writer.write(staticString + "\n");
            writer.write(i + "\n");
            writer.write(j + "\n");
            writer.flush(); //сохроняем
        }

        public void load(InputStream inputStream) throws Exception {
            //implement this method - реализуйте этот метод
            // читаем данные согласно записи
