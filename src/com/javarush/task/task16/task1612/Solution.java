...
public class Solution {
    ...
    public static class Stopwatch extends Thread {
        ...
        private void doStep() throws InterruptedException {
            stepNumber++;
            System.out.println(owner.getName() + " " + owner.getSpeed()*2 + " шагов делает за 2 секунды");
            Thread.sleep(1000/owner.getSpeed()); // тут секунду делим на колличество пройденых шагов
